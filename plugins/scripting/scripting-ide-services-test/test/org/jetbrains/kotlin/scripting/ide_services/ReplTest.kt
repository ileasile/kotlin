...
import org.jetbrains.kotlin.scripting.ide_services.test_util.captureOut
import org.jetbrains.kotlin.scripting.ide_services.test_util.simpleScriptCompilationConfiguration
import org.jetbrains.kotlin.scripting.ide_services.test_util.simpleScriptEvaluationConfiguration
...
class ReplTest : TestCase() {
    ...
    companion object {
        private fun evaluateInRepl(
            ...
            val replCompiler = KJvmReplCompilerImpl()
            ...
            return snipetsLimited.mapIndexed { snippetNo, snippetText ->
                ...
                replCompiler.compile(snippetSource, compilationConfiguration)
                    .onSuccess {
                        replEvaluator.eval(it, currentEvalConfig)
                    }
                    .onSuccess {
                        it().asSuccess()
                    }
