...
class CodeAnalyzer(private val environment: KotlinCoreEnvironment) {
    ...
    private fun doStatelessAnalyze(linePsi: KtFile, importedScripts: List<KtFile>): ReplLineAnalysisResult {
        ...
        val diagnostics = trace.bindingContext.diagnostics
        return ReplLineAnalysisResult.Stateless(
            diagnostics,
    ...
    class ResettableAnalyzerState {
        private val successfulLines =
            ReplHistory<CompiledCode, LineInfo.SuccessfulLine>()
