...
class KJvmReplCompleter(
    ...
    fun getCompletion(): List<CompletionVariant> {
        ...
        if (simpleExpression != null) {
            ...
            return file.listFiles { p, f -> p == file && f.startsWith(namePrefix, true) }?.map {
                CompletionVariant(it.name, it.name, "file", "file")
            } ?: emptyList()
        ...
        val result: MutableList<CompletionVariant> = ArrayList()
        ...
        if (descriptors != null) {
            ...
            (descriptors as ArrayList<DeclarationDescriptor>)
                .map {
                    val presentation = getPresentation(it)
                ...
                .forEach {
                    ...
                    if (rawName.startsWith(prefix)) {
                        val fullName: String = formatName(presentableText, NUMBER_OF_CHAR_IN_COMPLETION_NAME)
                        result.add(
                            CompletionVariant(
                                completionText,
                                fullName,
    ...
    companion object {
        ...
        private fun keywordsCompletionVariants(
            ...
            return keywords.types.mapNotNull {
                ...
                else CompletionVariant(token, token, "keyword", "keyword")
            }
        }
        ...
        fun getPresentation(descriptor: DeclarationDescriptor): DescriptorPresentation {
            ...
            return DescriptorPresentation(rawDescriptorName, presentableText, tailText, completionText)
        }
    }
}
