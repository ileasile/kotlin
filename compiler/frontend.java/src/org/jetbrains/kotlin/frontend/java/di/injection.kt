...
import org.jetbrains.kotlin.resolve.calls.tower.DefaultImplicitsExtensionsResolutionFilter
...
fun createContainerForLazyResolveWithJava(
    ...
    implicitsResolutionFilter: ImplicitsExtensionsResolutionFilter = DefaultImplicitsExtensionsResolutionFilter(),
    ...
    useInstance(implicitsResolutionFilter)
